...
VIZI.topoJSONTileLayer('https://{s}.tile.nextzen.org/tilezen/vector/v1/all/{z}/{x}/{y}.topojson?api_key=rRhSxwrKR4q6Enrlw1ikEQ', {
// VIZI.topoJSONTileLayer('https://{s}.tile.nextzen.org/tilezen/vector/v1/buildings/{z}/{x}/{y}.topojson?api_key=rRhSxwrKR4q6Enrlw1ikEQ', {
// VIZI.topoJSONTileLayer('https://{s}.data.osmbuildings.org/0.2/anonymous/tile/{z}/{x}/{y}.json', {
// VIZI.topoJSONTileLayer('https://tile.nextzen.org/tilezen/vector/v1/buildings/{z}/{x}/{y}.topojson?api_key=rRhSxwrKR4q6Enrlw1ikEQ', {
  interactive: false,
